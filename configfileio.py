...
class configfileio: 
    ...
    def save_global_parameters(self,tosave):
        try:
            ...
            'email_timeout':'global_email_timeout','PWB':'global_PWB','PLD':'global_PLD','email_sendername':'global_email_sendername',
            ...
            'password':'global_password','locked':'global_locked', 'suppliedbydhcp':'global_suppliedbydhcp','webenabled':'global_webenabled'} #'type_n':'global_type_n',
            savedict={}
